    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <h3 class="kt-subheader__title">{{isset($department) ? 'Modifier Service Info' : 'Ajouter un Service'}}</h3>

                <span class="kt-subheader__separator kt-subheader__separator--v"></span>

                <span class="kt-subheader__desc">ESSAADA-45670</span>
            ...
            <div class="kt-subheader__toolbar">
                <div class="kt-subheader__wrapper">
                    <a href="#" class="btn kt-subheader__btn-secondary">Jour</a>

                    <a href="#" class="btn kt-subheader__btn-secondary">Mois</a>

                    <a href="#" class="btn kt-subheader__btn-secondary">Année</a>
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                {{isset($department) ? 'Modifier Service Info' : 'Ajouter un service'}}
                            </h3>
                        </div>
                    </div>

    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <h3 class="kt-subheader__title">Liste des Services</h3>
                            ...
                            <td>
                                <span class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{route('services.show',$service->id)}}" class="dropdown-item"><i
                                                class="la la-eye"></i>Afficher</a>
                                    </div>
                                </span>

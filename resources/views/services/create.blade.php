    ...
    <div class="kt-subheader  kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                ...
                <h3 class="kt-subheader__title">{{isset($service) ? 'Modifier Service Info' : 'Ajouter Service'}}</h3>
                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            {{isset($service) ? 'Modifier Service Info' : 'Ajouter Service'}}
                        </h3>
                    </div>
                </div>
                        ...
                        <div class="form-group form-group-last">
                            <div class="alert alert-secondary" role="alert">
                                ...
                                <div class="alert-text">
                                    Vous pouvez ajouter un nouveau service directement ici !
                                </div>
                            </div>
                        </div>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="department" id="department">
                                    <option>séléctionner départment</option>
